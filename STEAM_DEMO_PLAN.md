...
| `yarn test:smoke` | 124 checks driving the real game: the whole loop from menu to victory and to death, the economy, the Warden and the noise it hears, the locked vault, the three puzzles won, lost and walked away from, the arena's arms, what a deliberately stalled frame does to the Warden and to a beam arriving on the player, a beam walked out of at a walk and mired, the records, the editor and the content pipeline | a dev server on 5199, Chromium |
