...
fixed properly this round; the rest are described in PLAYTEST §44 along
...
Runs 7 to 10 have shipped in this order, each on `main` and the live site; the ten loops begin at run 11, and runs 11 to 18 have shipped.
