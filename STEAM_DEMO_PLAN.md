...
fixed properly this round; the rest are described in PLAYTEST §49 along
...
Runs 7 to 10 have shipped in this order, each on `main` and the live site; the ten loops begin at run 11, and runs 11 to 20 have shipped. Runs 21 to 25 are the refinement - the brief after the loops: what is there works together and is worth looking at - and runs 21 to 23 have shipped.
