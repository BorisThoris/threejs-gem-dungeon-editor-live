...
| `yarn test:audio` | 15 checks that listen, reporting the tightest margin any of them had: it taps whatever connects to the speakers before the app loads and measures samples - every cue heard over the room tone, the loud ones well clear of it, muting silent, the ambient bed opening up when the floor is roused | as above |
