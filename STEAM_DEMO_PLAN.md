...
| 23 | **The first room of a floor is a sanctuary.** Nothing that hunts comes into the room a floor starts you in while the player is still standing there - the Warden's step, the Harrier's waking and the thief's arrival all ask one predicate - and it is an ordinary room the moment they leave it and come back. The floor's patience ends it too, so the stairs are not a place to wait. | The first breath of a floor is free because it is only the first. |
