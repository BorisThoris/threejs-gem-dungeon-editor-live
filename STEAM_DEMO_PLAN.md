...
fixed properly this round; the rest are described in PLAYTEST §40 along
...
Runs 7 to 10 have shipped in this order, each on `main` and the live site; the ten loops begin at run 11, and runs 11 to 14 have shipped.
