...
const CUES = [
  ...
  ["landmark", 650, ["hoist"]],
  ["landmark", 750, ["cantor"]],
  ["secretTrail", 400, ["rootwell", false]],
  ["secretTrail", 400, ["hoist", false]],
  ["secretTrail", 450, ["cantor", false]],
  ["secretTrail", 500, ["cantor", true]],
 ...
 */
{
  const airs = await page.evaluate(async (flush) => {
    ...
    const out = {};
    for (const id of ["drip", "wind", "ember", "creak", "hum", "hollow", "spore", "sift", "tick", "hiss"]) {
