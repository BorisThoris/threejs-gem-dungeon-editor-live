import type { Room } from "../src/game/dungeon/types";
import { DIR_STEP } from "../src/game/dungeon/types";
import { roomRayReach, wallEdges } from "../src/game/dungeon/footprint";
import { terracesFor, floorHeightAt } from "../src/game/worldbuilding/elevation";
import { SENTRY_HALF_ANGLE, SENTRY_RANGE } from "../src/game/world";
