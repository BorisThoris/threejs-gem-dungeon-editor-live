...
await build({stdin:{contents:`export * from './src/game/sentry/beamProjection'; export * from './src/game/dungeon/generate'; export * from './src/game/sentry/placement';`,resolveDir:process.cwd()},define:{'import.meta.env.DEV':'false','import.meta.env':'{}'},bundle:true,platform:'node',format:'esm',outfile:out});
