...
export const CREATURES: Record<MobId, CreatureSpec> = {
  ...
  croaker: {
    ...
    role: "ambient",
    body: "ground",
    lives: "At the water's edge of flooded and fungal rooms, gathering at live channels and retreating to damp wall refuges after drainage; never where a puzzle is played.",
    harm: "none",
    answers: ["stand over them and they hush", "anything loud, and they are under", "drain their channel and they leave it quietly"],
