...
export function Audio() {
  ...
  useEffect(() => {
    ...
    const air = biome === "flooded" ? 1.35 : biome === "mossy" ? 0.65 : biome === "ash" ? 0.72 : biome === "foundry" ? 1.15 : biome === "salt" ? 1.08 : biome === "verdigris" ? 0.92 : biome === "tallow" ? 0.8 : 1;
    const resonance = biome === "crystal" ? 27.5 : biome === "salt" ? 12 : biome === "bone" ? -9 : biome === "verdigris" ? 6 : biome === "tallow" ? -4 : 0;
