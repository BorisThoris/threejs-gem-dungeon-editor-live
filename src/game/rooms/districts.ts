...
export const DISTRICTS = {
  ...
  works: { name: "The old works", biomes: ["foundry", "ash", "verdigris", "hewn", "timber", "catacomb", "crystal", "bone", "flooded", "mossy"] },
  tombs: { name: "The buried choir", biomes: ["bone", "catacomb", "ash", "crystal", "salt", "tallow", "hewn", "timber", "foundry", "flooded", "mossy"] },
} as const;
export type DistrictId = keyof typeof DISTRICTS;

const PRIMARY_STRATA: Record<DistrictId, number> = { gardens: 4, works: 4, tombs: 6 };
