...
export const DELVERS: Record<DelverId, Delver> = {
  ...
  robber: {
    ...
    brings: "The Assayer's Chit, and two gems already in hand",
  ...
  courier: {
    ...
    brings: "The Cutter's Cant: the shop shows you a third thing",
  ...
  pilgrim: {
    ...
    brings: "Four lives and the Gutter Hood: the veins read a band earlier",
